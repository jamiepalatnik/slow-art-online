...
def get_random_image():
    pass
    # # Get a list of object IDs that are highlights and have images
    # try:
    ...
    random_objectID = str(random.choice(highlights))

    url = "https://collectionapi.metmuseum.org/public/collection/v1/objects/" + random_objectID
    ...
    return render_template("random-image.html", random_image=random_image)
